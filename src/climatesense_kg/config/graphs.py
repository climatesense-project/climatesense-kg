...
WIKIDATA_ENRICHER_SOURCE_NAME = "wikidata-enricher"
WIKIDATA_ENTITY_SOURCES = frozenset({"opentapioca", "refined"})

ENRICHMENT_GRAPH_ENTITY_SOURCES = {
    DBPEDIA_ENRICHER_SOURCE_NAME: DBPEDIA_ENTITY_SOURCES,
    WIKIDATA_ENRICHER_SOURCE_NAME: WIKIDATA_ENTITY_SOURCES,
}
